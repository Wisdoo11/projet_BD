...
public class FenetreChoixCatAjoutProdSalle extends JDialog {
	
	private JComboBox<String> Categorie;
	private boolean estAdmin;

	public FenetreChoixCatAjoutProdSalle(JFrame parent, String title, boolean modal, boolean estAdmin){
	...
	private void initComponent(){
		...
		Requete requete = new Requete("select distinct nom_categorie from Salle1");

...
insert into Categorie1 values ('Electromenager', 'Appareils et outils electriques domestiques');
insert into Categorie1 values ('Meuble', 'Grandes varietes de meubles ...');
...
insert into Categorie1 values ('Telephonie', 'Telephones et accessoires telephoniques (ecouteurs, kits mains-libres, etc) ');
insert into Categorie1 values ('Tv_son_photo', 'Televisions, enceintes, appareils photo et accesoires ...');
...
--peuplage de la table Vente1, pour la salle1
...
insert into Enchere1(email, id_vente, prix_propose, temps, quantite) values ('alex@gmail.com', 1, 8.2, TO_DATE('2018-12-06 10:15:00', 'YYYY-MM-DD HH24:MI:SS'), 2);
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Taille de lecran', 2, '15.4 pouces');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Taille', 5, '38/40');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Capacite', 7, '1.8 litres');
insert into Caracteristique1(nom, id_produit, valeur) values ('Numero du modele', 7, 'ECAM 22.110.B');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Capacite', 8, '45 litres');
insert into Caracteristique1(nom, id_produit, valeur) values ('Numero du modele', 8, ' CMG636BW1');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Capacite', 9, '25 litres');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Retroeclairage', 10, 'Non');
insert into Caracteristique1(nom, id_produit, valeur) values ('Type de produit', 11, 'Unite centrale uniquement');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Memoire', 11, '32');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Resolution', 12, '7200 cpi');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Retroeclairage', 13, 'Oui : multicouleur');
...
insert into Caracteristique1(nom, id_produit, valeur) values ('Mecanisme', 13, 'Clavier mecanique avec pave numerique');
